import { HabitType, HabitOccurrence, NotificationConfig, ISODateString } from './habit';
...
export const isValidStoredHabit = (value: any): value is StoredHabit => {
  return typeof value === 'object' &&
         ...
         (value.occurrence.type === 'daily' || 
          (value.occurrence.type === 'custom' && Array.isArray(value.occurrence.days))) &&
...
export const createHabitId = (timestamp: number, randomPart: string): HabitId => {
