...
export const HabitProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const saveHabit = useCallback(async (habit: StoredHabit): Promise<boolean> => {
    try {
  ...
  const updateHabit = useCallback(async (updatedHabit: StoredHabit): Promise<boolean> => {
    try {
      ...
      if (Platform.OS !== 'web' && needsNotificationUpdate(oldHabit, updatedHabit)) {
  ...
  const saveProgress = useCallback(async (progress: HabitProgress): Promise<boolean> => {
    try {
